                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                HStack(spacing: 6) {
                                    ...
                                    Text(guest.tier)
                                        ...
                                        .foregroundStyle(guest.tier == "High Networth" ? AppColors.success : AppColors.warning)
                                        .padding(.horizontal, 5)
                                        .padding(.vertical, 2)
                                        .background(guest.tier == "High Networth" ? AppColors.success.opacity(0.15) : AppColors.warning.opacity(0.15))
